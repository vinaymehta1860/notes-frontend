...
class Modal extends React.Component {
  ...
  render() {
    ...
    const ModaltoImport = this.props.modal, includeBottomBar = this.props.modal.includeBottomBar;
    let closeButton, cancelButton, successButton;

    if(close) {
      closeButton = <button className="modal-close" onClick={this.closeModal}>Close</button>;
    }
